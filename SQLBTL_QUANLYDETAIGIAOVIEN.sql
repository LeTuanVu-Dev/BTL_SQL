...
ALTER TABLE dbo.BOMON ALTER COLUMN iBDNhiemKy DATE 
ALTER TABLE dbo.BOMON ALTER COLUMN iKTNhiemKy DATE
ALTER TABLE dbo.BOMON ADD CONSTRAINT CK_Bomon CHECK (YEAR(iKTNhiemKy) >YEAR(iBDNhiemKy) )
UPDATE SET
------------------------------------------
-- Tạo bảng chủ đề
CREATE TABLE CHUDE
